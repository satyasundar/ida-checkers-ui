...
export const typeUrlMsgCreateGame = "/satya.checkers.checkers.MsgCreateGame";
export const typeUrlMsgCreateGameResponse =
  "/satya.checkers.checkers.MsgCreateGameResponse";
export const typeUrlMsgPlayMove = "/satya.checkers.checkers.MsgPlayMove";
export const typeUrlMsgPlayMoveResponse =
  "/satya.checkers.checkers.MsgPlayMoveResponse";
...
export interface MsgCreateGameEncodeObject extends EncodeObject {
  readonly typeUrl: "/satya.checkers.checkers.MsgCreateGame";
...
export interface MsgCreateGameResponseEncodeObject extends EncodeObject {
  readonly typeUrl: "/satya.checkers.checkers.MsgCreateGameResponse";
...
export interface MsgPlayMoveEncodeObject extends EncodeObject {
  readonly typeUrl: "/satya.checkers.checkers.MsgPlayMove";
...
export interface MsgPlayMoveResponseEncodeObject extends EncodeObject {
  readonly typeUrl: "/satya.checkers.checkers.MsgPlayMoveResponse";
